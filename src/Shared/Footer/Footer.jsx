...
const Footer = () => {
  ...
  return (
    <div className="bg-neutral">
      <footer className="footer max-w-7xl mx-auto p-10  text-neutral-content mt-10">
        <aside>
          <img src={logo} className="w-10 h-10 rounded-full" alt="" />
          <p>
            <span className="text-lg">Top Product</span>
            <br />
        ...
        <div>
          ...
          <p>(3rd Floor) Road # 17, Nikanjia-2 Dhaka</p>
        </div>
      </footer>
    </div>
  );
